...
- [X] Instruir a LLM para gerar a resposta em JSON e dizer para ela que a resposta será convertida em audio. Portanto ele deve retorna de forma separada qualquer conteudo que não deve ser falado e deve ser enviado como texto. Ex.: Links, Código de barras e etc
...
- [ ] Configurar no AgentOptions quais grupos de tools e mcp utilizar (Tools: [ "internal.date" ], Mcps: [ "midesp" ])
  ...
  ### SystemMessage
  ...
- [x] Obter config AIProvider do workspace em vez do appsettings